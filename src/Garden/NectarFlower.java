...
public class NectarFlower implements Flower {
    ...
    public void load(double xPosition, double yPosition) {
        ...
        this.xPosition = xPosition;
        this.yPosition = yPosition;
        this.flowerImage = new ImageView(new Image("file:C:\\Users\\vermaa\\Documents\\GitHub\\Garden-Sim-SE2811\\daisy.jpg"));
